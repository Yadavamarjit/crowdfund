                ...
                <div className="navbar-container">
                    ...
                    <div className="links">
                        <a className="toggle-nav">
                            {
                                click?<MenuIcon onClick={onmodal} />:""
                            }
                        </a>
                    ...
                    <Popup className="nav-modal" size="lg" show={hideModal}>
                        {/* <ClearIcon onClick={()=>{showModal(false)}} className="modal-close-btn" /> */}
                        <ClearIcon onClick={clicked} className="modal-close-btn" />
                        <div className="toggle-link">
                            <a className="nav-toggle-text">About</a>
                            <hr />
                            <a className="nav-toggle-text" >Discover</a>
                            <hr />
                            <a style={{marginBottom:"20px"}} className="nav-toggle-text" >Get Started</a>
